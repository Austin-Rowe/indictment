...
const Products = (props) => {
    return ( 
        <div id="products-container">
            ...
            <ProductTile id={5} title="TICK TOCK HOURGLASS THERMAL" dispatch={props.dispatch} imgSrc="shirts/Red_Shirt.png" description='BLUE ON RED' limitedEdition soldOut price={38} />
